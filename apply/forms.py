...
from .models import Student, Course, Region, District, Kitongoji

class StudentForm(forms.ModelForm):
    class Meta:
        model = Student
        fields = ['fullname','email','gender','phone','course','region','district','kitongoji']
        widgets = {
            ...
            'kitongoji': forms.Select(attrs={'class':'form-select cascade-kitongoji'}),
...
class CourseForm(forms.ModelForm):
    class Meta:
        model = Course
        fields = ['course_id','title','lecturer','duration_months','cost','description']
        widgets = {
